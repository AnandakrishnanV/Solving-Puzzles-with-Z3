                                 ...
                                 If(And(z > 2, grid[i][2] == 0),
                                    If(And(z > 3, grid[i][3] == 0),
                                        If(And(z > 4, grid[i][4] == 0),
                                           If(And(z > 5, grid[i][5] == 0),grid[i][6], grid[i][5]),
                                           grid[i][4]),
                                       grid[i][3]),
                                    grid[i][2],),
                                 grid[i][1],),
                                 ...
                                 If(And(z > 2, grid[i][mi-2] == 0),
                                    If(And(z > 3, grid[i][mi-3] == 0),
                                        If(And(z > 4, grid[i][mi-4] == 0),
                                           If(And(z > 5, grid[i][mi-5] == 0), grid[i][mi-6], grid[i][mi-5]),
                                           grid[i][mi-4]),
                                       grid[i][mi-3]),
                                    grid[i][mi-2],),
                                 grid[i][mi-1],),
                                 ...
                                 If(And(z > 2, grid[2][j] == 0),
                                    If(And(z > 3, grid[3][j] == 0),
                                        If(And(z > 4, grid[4][j] == 0),
                                           If(And(z > 5, grid[5][j] == 0), grid[6][j] ,grid[5][j]),
                                           grid[4][j]),
                                       grid[3][j]),
                                    grid[2][j],),
                                 grid[1][j],),
                                 ...
                                 If(And(z > 2, grid[mi-2][j] == 0),
                                    If(And(z > 3, grid[mi-3][j] == 0),
                                        If(And(z > 4, grid[mi-4][j] == 0),
                                           If(And(z > 5, grid[mi-5][j] == 0), grid[mi-6][j], grid[mi-5][j]),
                                           grid[mi-4][j]),
                                       grid[mi-3][j]),
                                    grid[mi-2][j],),
                                 grid[mi-1][j],),
